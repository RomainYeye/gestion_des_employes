...
<html>
    ...
    <body>
        ...
        if(!$_POST && $_GET) {
            if (isset($_GET["dluser"])) {
                $userDAO= new UserDataAccess();
                $userService=new ServiceUser($userDAO);
                $userService->dl($_GET["dluser"]);
                header("location: main_page_utilisateurs.php");
            }
        }

        if(isset($_POST["postedituser"])) {
            $userDAO=new UserDataAccess();
            $userService=new ServiceUser($userDAO);
        ...
        <div class="container-fluid">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <form method="post" action="main_page_utilisateurs.php">
                    ...
                    <?php
                        $userDAO=new UserDataAccess();
                        $userService=new ServiceUser($userDAO);
                        $dataUsers=$userService->selectAll();
                        displayTable($dataUsers, $admin, "user");
